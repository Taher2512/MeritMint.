  ...
  return (
    <>
      <div className="absolute z-10 left-1/4 mt-5 px-8 py-5 bg-white/30 w-1/2 rounded-xl backdrop-blur-sm flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
        >
          <svg
            class="w-4 h-4 me-2"
            aria-hidden="true"
